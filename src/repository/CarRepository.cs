public class CarRepository
{
    public static List<Car> CarList { get; } = new List<Car>
    {
        ...
        new Car { Id = 4, Brand = "Mercedes-Benz", Model = "Maybach",Description=" A pinnacle of automotive luxury, blending sophistication with cutting-edge technology. With its opulent interior and refined engineering, it offers unparalleled comfort and prestige on the road.",CarImage="image\\Maybach.png",isReserved=false},
        new Car { Id = 2, Brand = "Lamborghini", Model = "Huracan",Description="A sleek and powerful supercar, epitomizing speed and style on the road. With its striking design and exhilarating performance, it captivates enthusiasts worldwide.",CarImage="image\\Huracan.png",isReserved=false},
        new Car { Id = 3, Brand = "Ferrari", Model = "Ferrari 812 GTS",Description="A marvel of engineering and design, embodying raw power and exhilarating performance. With its iconic Ferrari lineage and open-top driving experience, it delivers thrills like no other.",CarImage="image\\Ferrari.png",isReserved=false},
